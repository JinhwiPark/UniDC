...
parser.add_argument('--dir_data', help='path to dataset')
...
parser.add_argument('--lidar_lines', default=64, help='the extracted lidar lines [KITTI-DC]')
parser.add_argument('--num_sample',  default=500, help='number of sparse samples [NYU-DC]')
# Validation Set ebu
parser.add_argument('--nyu_val_samples', type=str, default='500')
parser.add_argument('--kitti_val_lidars', type=str, default='64')
# parser.add_argument('--kitti_val_lidars', type=str, default='64,8,1')
# parser.add_argument('--nyu_val_samples', type=str, default='500,32,5')
...
parser.add_argument('--exp_name', type=str, choices=('SparsityChange', 'PatternChange', 'RangeChange-Far',
                                                ...
                                                'PR_SR_SPR_comb','SP_comb','Ablation_SP','Ablation_R'))
...
# parser.add_argument('--non_official_nlspn', action='store_true', default=False)
...
parser.add_argument('--all_frame_ipad', action='store_true', default=False)
...
parser.add_argument('--hyperbolic_mode', default='model1', type=str)
parser.add_argument('--hyperbolic_p2e_use', default=False, action='store_true')
parser.add_argument('--hyperbolic_kernelsize', default=3, type=int)
parser.add_argument('--hyperbolic_c', default=0.1, type=float)
parser.add_argument('--clipping', default=False, action='store_true')
parser.add_argument('--clip_param', default=1.0, type=float)


# Equivariance Config
parser.add_argument('--affinity_equivariance', default=False, action='store_true')
parser.add_argument('--alpha_affinity_equivariance', default=0.1, type=float)
parser.add_argument('--save_affinity_equivariance', type=str, help='file name to save')

parser.add_argument('--prop_time', type=int, default=6, help='number of propagation')
parser.add_argument('--neighbor', type=int, default=4, help='number of propagation')
...
parser.add_argument('--fewshot_nopretrain', action='store_true',default=False)


parser.add_argument('--few_shot_way', type=str, choices=('random', 'one_sequence', '1-shot_for_each_sequence','1-percent_for_each_sequence'), default='random')
parser.add_argument('--nyu_sequence_name', type=str, choices=('conference_room_0001', 'bathroom_0001', 'bedroom_0094','dining_room_0010','office_0004','living_room_0039'), default='conference_room_0001')
parser.add_argument('--kitti_sequence_name', type=str, choices=('2011_09_26_drive_0001_sync', '2011_09_28_drive_0001_sync', '2011_09_30_drive_0018_sync','2011_10_03_drive_0042_sync','2011_09_29_drive_0004_sync'), default='2011_09_26_drive_0001_sync')

parser.add_argument('--minidataset_fewshot_number', type=int, default=10)
parser.add_argument('--save_depth_check', action='store_true', default=False)

#
parser.add_argument('--multiple_times', action='store_true',default=False)
parser.add_argument('--num_multiple_times', type=int)
parser.add_argument('--validation_epochs', type=str, default='20,40,100')
parser.add_argument('--seed', default=None, type=int,  help='seed for initializing training. ')
